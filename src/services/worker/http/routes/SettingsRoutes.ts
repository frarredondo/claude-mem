...
import { parseOpenRouterProviderSlug } from '../../../../shared/openrouter-provider-routing.js';
...
export class SettingsRoutes extends BaseRouteHandler {
  ...
  private handleUpdateSettings = this.wrapHandler((req: Request, res: Response): void => {
    ...
    const settingKeys = [
      ...
      'CLAUDE_MEM_OPENROUTER_PROVIDER',
  ...
  private validateSettings(settings: any): { valid: boolean; error?: string } {
    ...
    if (settings.CLAUDE_MEM_OPENROUTER_PROVIDER !== undefined) {
      const parsed = parseOpenRouterProviderSlug(settings.CLAUDE_MEM_OPENROUTER_PROVIDER);
      if (!parsed.ok) {
