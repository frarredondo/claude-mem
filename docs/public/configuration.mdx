...
| `CLAUDE_MEM_OPENROUTER_MODEL`                | `deepseek/deepseek-v4-flash-0731` | Model identifier (supports 100+ models) |
| `CLAUDE_MEM_OPENROUTER_PROVIDER`             | —                           | Optional OpenRouter endpoint slug (e.g. `anthropic`). Empty = automatic routing. |
